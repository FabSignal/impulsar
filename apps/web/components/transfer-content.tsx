          ...
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                {activeTab === "bank"
                  ? `Transferiste ${formatARS(Number.parseFloat(transferAmount))} a tu cuenta bancaria`
                  : `Retiro de ${formatARS(Number.parseFloat(transferAmount))} en Pago Fácil autorizado`}
              </p>
              <p className="text-sm text-muted-foreground mt-2">
                {activeTab === "pagofacil" && "Presentá tu DNI en cualquier sucursal de Pago Fácil"}
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="font-bold text-lg">Retirar Dinero</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="border-border/40">
          <CardHeader>
            ...
            <CardTitle className="text-3xl">{formatARS(walletData.arsBalance)}</CardTitle>
          </CardHeader>
        </Card>
        ...
        <Card className="border-border/40">
          <CardHeader>
            ...
            <CardDescription>Elegí cómo querés recibir tu dinero</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {Number.parseFloat(transferAmount) > walletData.arsBalance && (
              <p className="text-sm text-destructive text-center mt-4">Saldo insuficiente</p>
            )}
          </CardContent>
        </Card>
      </div>
